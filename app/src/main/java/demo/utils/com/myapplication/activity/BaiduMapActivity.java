...
import demo.utils.com.myapplication.baidu_map.AddressToLatitudeLongitude;
import demo.utils.com.myapplication.baidu_map.MyOrientationListener;
...
//    private BitmapDescriptor myIconLocation2;//图表2,前往位置的中心图标
    ...
    private MyOrientationListener myOrientationListener;//方向感应器类对象从
...
//    private MyLocationConfiguration.LocationMode locationMode2;//定位图层显示方式
    ...
    private void initLocation() {
        ...
        myIconLocation1 = BitmapDescriptorFactory.fromResource(R.mipmap.location_marker);
